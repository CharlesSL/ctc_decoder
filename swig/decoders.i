...
namespace std {
    ...
    %template(PairTime) std::pair<int, int>;
    %template(Pair) std::pair<float, std::vector<std::pair<int, int>>>;
    %template(PairFloatVectorVector)  std::vector<std::pair<float, std::vector<std::pair<int, int>>>>;
    %template(PairDoubleVectorVector) std::vector<std::pair<double, std::vector<std::pair<int, int>>>>;
    %template(PairDoubleVectorVector2) std::vector<std::vector<std::pair<double, std::vector<std::pair<int, int>>>>>;
